      ...
      <div className="contact-container">
        <div className="contacto margin-contact">
          ...
          <p className="contact-text">
            Ante cualquier duda o consulta podés comunicarte con nosotros a
            través de:
          </p>
          <a
            href="https://www.instagram.com/malvina.uruguay/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="mailto:malvina.uruguay@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
